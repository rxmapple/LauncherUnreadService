 ...
 */
package com.simon.launcherunreadservice;
...
public class LauncherUnreadService extends Service {
    ...
    private ComponentName mMmsComponentName =
            ComponentName.unflattenFromString("com.android.messaging/.ui.conversationlist.ConversationListActivity");
    private ComponentName mDialerComponentName =
            ComponentName.unflattenFromString("com.android.dialer/.DialtactsActivity");

    private static final String ACTION_UNREAD_CHANGED = "com.simon.action.UNREAD_CHANGED";
    private static final String EXTRA_UNREAD_COMPONENT = "com.simon.intent.extra.UNREAD_COMPONENT";
    private static final String EXTRA_UNREAD_NUMBER = "com.simon.intent.extra.UNREAD_NUMBER";
    ...
    private void sendUnreadChangedBroadcast(ComponentName componentName, int unreadCount) {
        ...
        intent.putExtra(EXTRA_UNREAD_NUMBER, unreadCount);
        intent.putExtra(EXTRA_UNREAD_COMPONENT, componentName.flattenToShortString());
